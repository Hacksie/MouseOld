...
namespace HackedDesign {
	public class StartMenuPanelPresenter : MonoBehaviour {
		...
		public void Repaint () {
			if (CoreGame.Instance.CoreState.state == GameState.STARTMENU && !this.gameObject.activeInHierarchy) {
				Show (true);
			} else if (CoreGame.Instance.CoreState.state != GameState.STARTMENU && this.gameObject.activeInHierarchy) {
				Show (false);
			}
		}
